<?php function pk_portada_landing($pk_category, $pag = null){
...
<div class="container-fluid cover"  id="" data-type="parallax" data-speed="20" style="background: url('<?php echo get_field("imagen_de_fondo");?>') top center; background-size:cover; background-repeat: no-repeat;" >
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 portada" style="background: transparent !important;">
...
<h1 style="color: #3d3c3b"><?= get_field("titulo_primera")?> <strong><?= get_field("titulo_segunda")?></strong></h1>
<h1 style="width: 50%; float: left; text-align: right;" class="hidden-xs"><strong><?= get_field("sustitulo")?></strong></h1>
<h2 style="color: #3d3c3b;width: 50%;float: left;text-align: center;line-height: 1.5;"><?= get_field("sustitulo2")?></h2>
                        </div>
                        <div class="clearfix"></div>
